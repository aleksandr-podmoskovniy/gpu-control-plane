...
// ApplyDefaults fills missing config fields from environment defaults.
func ApplyDefaults(cfg config.WorkloadConfig) config.WorkloadConfig {
...
// NewDeps builds a dependency bundle for pool workloads.
func NewDeps(log logr.Logger, c client.Client, cfg config.WorkloadConfig) deps.Deps {
