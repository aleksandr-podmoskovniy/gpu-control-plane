...
func (r *ClusterGPUPoolUsageReconciler) Reconcile(ctx context.Context, req reconcile.Request) (reconcile.Result, error) {
	...
	rec.SetHandlerExecutor(func(ctx context.Context, handler ClusterHandler) (reconcile.Result, error) {
