...
func NewGPUPoolUsage(log logr.Logger, cfg config.ControllerConfig, store *moduleconfig.ModuleConfigStore) *GPUPoolUsageReconciler {
	if cfg.Workers <= 0 {
		cfg.Workers = 1
	}
...
var _ reconcile.Reconciler = (*GPUPoolUsageReconciler)(nil)
