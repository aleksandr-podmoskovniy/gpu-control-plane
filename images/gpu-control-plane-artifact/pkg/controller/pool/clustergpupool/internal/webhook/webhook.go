...
func NewClusterGPUPoolValidator(log logr.Logger, c client.Client, handlers []AdmissionHandler) *ClusterGPUPoolValidator {
...
func NewClusterGPUPoolDefaulter(log logr.Logger, handlers []AdmissionHandler) *ClusterGPUPoolDefaulter {
