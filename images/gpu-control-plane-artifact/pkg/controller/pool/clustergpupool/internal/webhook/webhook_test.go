...
func (s *stubAdmissionHandler) SyncPool(_ context.Context, _ *v1alpha1.GPUPool) (reconcile.Result, error) {
	s.calls++
...
func TestClusterGPUPoolDefaulterAddsDefaults(t *testing.T) {
	...
	handlers := []AdmissionHandler{pooladmission.NewPoolValidationHandler(testr.New(t))}
...
func TestClusterGPUPoolValidator_AllowsCreateAndUpdate(t *testing.T) {
	...
	validator := NewClusterGPUPoolValidator(testr.New(t), cl, []AdmissionHandler{handler})
...
func TestClusterGPUPoolValidator_PropagatesHandlerErrors(t *testing.T) {
	...
	validator := NewClusterGPUPoolValidator(testr.New(t), cl, []AdmissionHandler{&stubAdmissionHandler{name: "stub", err: handlerErr}})
...
func TestClusterGPUPoolDefaulter_PropagatesHandlerError(t *testing.T) {
	...
	defaulter := NewClusterGPUPoolDefaulter(testr.New(t), []AdmissionHandler{&stubAdmissionHandler{name: "stub", err: handlerErr}})
