...
// MemoryCapacityMiB returns a capacity value in MiB.
...
// ShareableMemoryCapacityMiB returns a capacity value with share policy in MiB.
...
// SharePercentCapacity returns a 0-100 percent share capacity policy.
