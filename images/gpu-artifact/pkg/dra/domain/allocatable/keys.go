...
const (
	...
	AttrGPUUUID    = "nvidia.com/gpu.uuid"
	AttrDriverVer  = "nvidia.com/driverVersion"
	AttrCCMajor    = "nvidia.com/cc.major"
	AttrCCMinor    = "nvidia.com/cc.minor"
	AttrMigProfile = "nvidia.com/mig.profile"
