...
// NewLogger creates a module-wide logger instance.
...
// NewControllerLogger creates a controller-scoped logger with optional debug override.
...
// SetDefaultLogger wires deckhouse logger into controller-runtime and klog.
