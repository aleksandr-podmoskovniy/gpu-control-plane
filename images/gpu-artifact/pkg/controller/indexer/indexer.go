...
// IndexGetter returns object, field and indexing function.
type IndexGetter func() (obj client.Object, field string, extractValue client.IndexerFunc)

// IndexGetters keeps all index registration callbacks.
var IndexGetters []IndexGetter

// IndexALL registers all configured field indexers.
