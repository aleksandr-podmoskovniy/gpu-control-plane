...
import (
	...
	"github.com/aleksandr-podmoskovniy/gpu-control-plane/images/kube-api-rewriter/pkg/log"
	"github.com/aleksandr-podmoskovniy/gpu-control-plane/images/kube-api-rewriter/pkg/rewriter"
	"github.com/aleksandr-podmoskovniy/gpu-control-plane/images/kube-api-rewriter/pkg/server"
)
...
const PodJSON = `{
    ...
    "metadata": {
        ...
        "annotations": {
            ...
            "gpu.internal.gpu.deckhouse.io/allow-pod-bridge-network-live-migration": "true",
            "gpu.internal.gpu.deckhouse.io/domain": "cloud-alpine",
            "gpu.internal.gpu.deckhouse.io/migrationTransportUnix": "true",
            "gpu.internal.gpu.deckhouse.io/vm-generation": "1",
        ...
        "finalizers": [
            "gpu.deckhouse.io/pod-protection"
        ],
        "generateName": "virt-launcher-cloud-alpine-",
        "labels": {
            "gpu.internal.gpu.deckhouse.io": "virt-launcher",
            "gpu.internal.gpu.deckhouse.io/created-by": "ac1e83d8-f2ad-4047-8ba9-3f557c687b9f",
            "gpu.internal.gpu.deckhouse.io/nodeName": "virtlab-delivery-mi-2",
            "vm": "cloud-alpine",
            "vm-folder": "vm-cloud-alpine",
            "vm.gpu.internal.gpu.deckhouse.io/name": "cloud-alpine"
        },
        "name": "virt-launcher-cloud-alpine-lxlz5",
        "namespace": "vm",
        "ownerReferences": [
            {
                "apiVersion": "internal.gpu.deckhouse.io/v1",
                "blockOwnerDeletion": true,
                "controller": true,
                "kind": "InternalGPUControlPlaneVirtualMachineInstance",
                "name": "cloud-alpine",
    ...
    "spec": {
        ...
        "containers": [
            {
                "command": [
                    ...
                    "/var/run/gpu",
                    "--ephemeral-disk-dir",
                    "/var/run/gpu-ephemeral-disks",
                    "--container-disk-dir",
                    "/var/run/gpu/container-disks",
                ...
                "image": "dev-registry.deckhouse.io/sys/deckhouse-oss/modules/gpucontrolplane@sha256:c3c6c6a87ce0082697da80a6e53b4bf59fb433be05cabd9f7c46201bd45283e6",
                "imagePullPolicy": "IfNotPresent",
                "name": "compute",
                "resources": {
                    "limits": {
                        "cpu": "4",
                        "devices.gpu.deckhouse.io/kvm": "1",
                        "devices.gpu.deckhouse.io/tun": "1",
                        "devices.gpu.deckhouse.io/vhost-net": "1",
                        "memory": "4582277121"
                    },
                    "requests": {
                        "cpu": "4",
                ...
                "volumeMounts": [
                    ...
                    {
                        "mountPath": "/var/run/gpu-ephemeral-disks",
                        "name": "ephemeral-disks"
                    },
                    {
                        "mountPath": "/var/run/gpu/container-disks",
                    ...
                    {
                        "mountPath": "/var/run/gpu/sockets",
                        "name": "sockets"
                    },
                    {
                        "mountPath": "/var/run/gpu/hotplug-disks",
                        "mountPropagation": "HostToContainer",
                        "name": "hotplug-disks"
                    }
                ]
        ...
        "nodeSelector": {
            "cpu-model.node.gpu.deckhouse.io/Nehalem": "true",
            "kubernetes.io/arch": "amd64",
            "gpu.internal.gpu.deckhouse.io/schedulable": "true"
        },
        ...
        "readinessGates": [
            {
                "conditionType": "gpu.nvidia.com/virtual-machine-unpaused"
            }
        ],
        "restartPolicy": "Never",
        ...
        "tolerations": [
            ...
            {
                "effect": "NoSchedule",
                "key": "devices.gpu.deckhouse.io/kvm",
                "operator": "Exists"
            },
            {
                "effect": "NoSchedule",
                "key": "devices.gpu.deckhouse.io/tun",
                "operator": "Exists"
            },
            {
                "effect": "NoSchedule",
                "key": "devices.gpu.deckhouse.io/vhost-net",
                "operator": "Exists"
            }
        ],
	...
	"status": {
        "conditions": [
            ...
            },
            {
                ...
                "reason": "NotPaused",
                "status": "True",
                "type": "gpu.nvidia.com/virtual-machine-unpaused"
            },
            {
                "lastProbeTime": null,
                "lastTransitionTime": "2024-10-01T11:45:59Z",
        ...
        "containerStatuses": [
            {
                ...
                "imageID": "dev-registry.deckhouse.io/sys/deckhouse-oss/modules/gpucontrolplane@sha256:c3c6c6a87ce0082697da80a6e53b4bf59fb433be05cabd9f7c46201bd45283e6",
                "lastState": {},
                "name": "compute",
                "ready": true,
                "restartCount": 0,
...
func Test_run_proxy_with_pprof(t *testing.T) {
	...
	go func() {
		...
		rewriteRules := gpu.GPURewriteRules
		rewriteRules.Init()
