...
func TestRewriteAPIEndpoint(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			"/api/v1/namespaces/d8-gpu-control-plane/pods?labelSelector=labelgroup.io%3Dlabelvalue&limit=500",
			"/api/v1/namespaces/d8-gpu-control-plane/pods",
			"labelSelector=replacedlabelgroup.io%3Dlabelvalue&limit=500",
		},
		{
			"labelSelector prefixed label and value",
			"/api/v1/namespaces/d8-gpu-control-plane/pods?labelSelector=component.labelgroup.io%2Fsome-attr%3Dlabelvalue&limit=500",
			"/api/v1/namespaces/d8-gpu-control-plane/pods",
			"labelSelector=component.replacedlabelgroup.io%2Fsome-attr%3Dlabelvalue&limit=500",
		},
		{
			"labelSelector label name not in values",
			"/api/v1/namespaces/d8-gpu-control-plane/pods?labelSelector=labelgroup.io+notin+%28value-one%2Cvalue-two%29&limit=500",
			"/api/v1/namespaces/d8-gpu-control-plane/pods",
		...
		},
		{
			...
			"/api/v1/namespaces/d8-gpu-control-plane/pods?labelSelector=labelgroup.io%3DlabelValueToRename&limit=500",
			"/api/v1/namespaces/d8-gpu-control-plane/pods",
			"labelSelector=replacedlabelgroup.io%3DrenamedLabelValue&limit=500",
		},
		{
			"labelSelector label name and renamed values",
			"/api/v1/namespaces/d8-gpu-control-plane/pods?labelSelector=labelgroup.io+notin+%28value-one%2ClabelValueToRename%29&limit=500",
			"/api/v1/namespaces/d8-gpu-control-plane/pods",
